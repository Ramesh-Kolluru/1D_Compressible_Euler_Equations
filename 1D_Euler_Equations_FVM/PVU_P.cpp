...
void PVU_P_Dissipation(int & Cell_No)
{
  int Face_No=0;
 double Beta =0.0, Term1 = 0.0,u_R_Minus,u_R_Plus,u_L_Minus,u_L_Plus,a_R,a_L;
 u_L = 0.0; P_L = 0.0;Rho_L = 0.0; E_L=0.0;T_L =0.0;u_L_Minus =0.0;u_L_Plus=0.0,a_L=0.0;
 u_R = 0.0; P_R = 0.0;Rho_R = 0.0; E_R=0.0;T_R =0.0;u_R_Minus =0.0;u_R_Plus=0.0,a_R=0.0;
...
// values at i Left state values
    ...
    Phi[1] = 0.5;
    Phi[2] = 0.5;
    Min_Mod(Cell_No,Phi,Face_No);
//     cout<<Phi[0]<<"\t"<<Phi[1]<<"\t"<<Phi[2]<<endl;
    
    Left_Face_Dissipative_Flux[0] = 0.5*((1.0-Phi[0])*((G_C_R_Plus[0] - G_C_L_Plus[0])-(G_C_R_Minus[0] - G_C_L_Minus[0])) +
				    Phi[0]*((G_P_R_Plus[0] - G_P_L_Plus[0])-(G_P_R_Minus[0] - G_P_L_Minus[0])));
    Left_Face_Dissipative_Flux[1] = 0.5*((1.0-Phi[1])*((G_C_R_Plus[1] - G_C_L_Plus[1])-(G_C_R_Minus[1] - G_C_L_Minus[1])) + 
				    Phi[1]*((G_P_R_Plus[1] - G_P_L_Plus[1])-(G_P_R_Minus[1] - G_P_L_Minus[1])));
    Left_Face_Dissipative_Flux[2] = 0.5*((1.0-Phi[2])*((G_C_R_Plus[2] - G_C_L_Plus[2])-(G_C_R_Minus[2] - G_C_L_Minus[2])) + 
				    Phi[2]*((G_P_R_Plus[2] - G_P_L_Plus[2])-(G_P_R_Minus[2] - G_P_L_Minus[2])));
...
//     
    Right_Face_Dissipative_Flux[0] = 0.5*((1.0-Phi[0])*((G_C_R_Plus[0] - G_C_L_Plus[0])-(G_C_R_Minus[0] - G_C_L_Minus[0])) + 
				    Phi[0]*((G_P_R_Plus[0] - G_P_L_Plus[0])-(G_P_R_Minus[0] - G_P_L_Minus[0])));
    Right_Face_Dissipative_Flux[1] = 0.5*((1.0-Phi[1])*((G_C_R_Plus[1] - G_C_L_Plus[1])-(G_C_R_Minus[1] - G_C_L_Minus[1])) +
				    Phi[1]*((G_P_R_Plus[1] - G_P_L_Plus[1])-(G_P_R_Minus[1] - G_P_L_Minus[1])));
    Right_Face_Dissipative_Flux[2] = 0.5*((1.0-Phi[2])*((G_C_R_Plus[2] - G_C_L_Plus[2])-(G_C_R_Minus[2] - G_C_L_Minus[2])) + 
				    Phi[2]*((G_P_R_Plus[2] - G_P_L_Plus[2])-(G_P_R_Minus[2] - G_P_L_Minus[2])));
