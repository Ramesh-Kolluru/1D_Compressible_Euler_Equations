...
public:
  ...
  // plot a single vector 			title
  void plot_x(const vector<double>&,  const string &  );

  // plot a double vector
  //void plot_x(vector< vector<double > >, const string & 	);

  // plot x,y pairs
  void plot_xy(vector<double>, vector<double>,  const string  &  );

  // plot an equation of the form: y = ax + b
  // You supply a and b
  void plot_slope( double,  double,  const string &  );

  // plot an equation supplied as a string
  void plot_equation(const string &, const string & );
